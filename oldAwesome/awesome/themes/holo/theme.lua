...
theme.wallpaper                     = os.getenv("HOME") .. "/Pictures/Wallpapers/blue-black.jpg"

theme.topbar_path                   = "png:" .. theme.icon_dir .. "/topbar/"

theme.font                          = "Terminus 10.5"
theme.taglist_font                  = "Terminus 9"
theme.fg_normal                     = "#d6d7d9" --FFFFFF
theme.fg_focus                      = "#0099CC"
theme.bg_normal                     = "#242424" -- 242424
theme.fg_urgent                     = "#CC9393"
theme.bg_urgent                     = "#2A1F1E"
theme.border_width                  = "1"
theme.border_normal                 = "#111113" --252525
theme.border_focus                  = "#0099CC"
theme.taglist_fg_focus              = "#606163" --FFFFFF
theme.taglist_bg_focus              = "png:" .. theme.icon_dir .. "/taglist_bg_focus.png"
--theme.tasklist_bg_normal            = "#111113" --222222
