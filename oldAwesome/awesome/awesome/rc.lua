...
--AwesomeMPD
   ...
   musicwidget.background = "#002B36" --Set widget background color
...
arrl_dl = separators.arrow_left(beautiful.widget_bg, "alpha")
arrl_ld = separators.arrow_left("alpha", beautiful.widget_bg)
    ...
    local function right_layout_add (...)
        ...
        if right_layout_toggle then
            ...
            for i, n in pairs(arg) do
                right_layout:add(wibox.widget.background(n ,beautiful.widget_bg))
            end
        else
